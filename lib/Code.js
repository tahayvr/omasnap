...
var THEMES = [
    ...
    { key: "nord",      label: "Nord",      bat: "Nord",              bg: "#2e3440", fg: "#d8dee9" },
...
// Builds a 16-colour palette from the key=hex lines bin/snap-theme prints.
...
// Converts SGR-coloured terminal output to the HTML subset QML's RichText
// understands. Spaces become non-breaking so indentation survives.
function ansiToHtml(src, palette) {
    src = String(src || "").replace(/\r/g, "").replace(/\n+$/, "");
