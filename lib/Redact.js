...
// `short` is for the tool bar in the header, where the full labels do not fit.
var CLASSES = [
    { key: "email",  label: "Emails",        short: "Email",  members: ["email"] },
    { key: "secret", label: "Keys & tokens", short: "Keys",   members: ["jwt", "aws", "ghp", "sk", "bearer", "urlcred"] },
    { key: "card",   label: "Card numbers",  short: "Cards",  members: ["card", "iban"] },
    { key: "net",    label: "IP addresses",  short: "IPs",    members: ["ipv4"] },
    { key: "phone",  label: "Phone numbers", short: "Phones", members: ["phone"] }
];
